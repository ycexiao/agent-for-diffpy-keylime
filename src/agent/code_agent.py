...
code_vectorstore = FAISS.load_local(
    "code_vectorstore", embeddings, allow_dangerous_deserialization=True
)
...
if __name__ == "__main__":
    ...
    #     {
    #         "messages": "I have a PDF data generated by two phases presented inside. How to do the PDF refinement?"
    #     }
    # )
